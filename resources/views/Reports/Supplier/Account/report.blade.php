        ...
        <span>
            <div class="body-page">
                <htmlpageheader name="page-header">
                    ...
                    <div class="rep_name">
                        <span>{{$Title}}<br></span>
                        <p style="font-size: 14px;">({{$Supplier->name}})</p>
                    </div>
        ...
        <tbody>
            ...
            @foreach ($Entries as $i => $Entry)
                ...
                <tr>
                    ...
                    <td width="100">{{$Entry->entry_statment}}</td>
                </tr>
            @endforeach
            <tr>
                <td>-</td>
                <td>-</td>
                <td>-</td>
                <td style="background-color: rgb(148, 207, 255)">{{$Entries->sum('debit') + $OldEntries->debit}}جم</td>
                <td style="background-color: rgb(148, 207, 255)">{{$Entries->sum('credit') + $OldEntries->credit}}جم</td>
                <td>-</td>
                <td>-</td>
            </tr>
        </tbody>
