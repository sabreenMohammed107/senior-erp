...
<div class="row">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <ul class="breadcome-menu">
            ...
            <li>
                <span class="bread-blod"> تقرير حركة الخزينة </span>
            </li>
        </ul>
    </div>
</div>
...
<form action="{{url('/Reports/CashBox/Account/Fetch')}}" method="post">
    {{ csrf_field() }}
    <div class="container-fluid">
    <a href="{{url('/')}}" class="btn btn-primary waves-effect waves-light mg-b-15" data-toggle="modal" data-target="#add">رجــــــوع</a>
        <button type="submit" class="btn btn-primary waves-effect waves-light mg-b-15" data-toggle="modal" data-target="#add">عرض التقرير</button>
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="sparkline13-list">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 style="direction:rtl">بيانات الخزينه</h1><br />
                        </div>
                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mg-b-22"style="direction:rtl">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                                <select name="id" required data-placeholder="Choose a Cash box..." class="chosen-select">
                                                    <option value="" disabled selected>اختر</option>
                                                    @foreach ($CashBoxes as $Box)
                                                    <option value="{{$Box->id}}">{{$Box->ar_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                                <div class="input-mask-title">
                                                    <label><b>كود الخزينه</b></label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                                <div class="input-mark-inner mg-b-22">
                                                    <input required type="date" name="from_date" class="form-control" placeholder="">
                                                </div>
                                            </div>
                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                                <div class="input-mask-title">
                                                    <label><b>تاريخ البداية </b></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                                <div class="input-mark-inner mg-b-22">
                                                    <input required type="date" name="to_date" class="form-control" placeholder="">
                                                </div>
                                            </div>
                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                                <div class="input-mask-title">
                                                    <label><b>تاريخ النهاية </b></label>
                                                </div>
                                            </div>
                                        </div>
