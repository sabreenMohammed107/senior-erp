    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <div class="breadcome-heading">
            <div class="add-product">
                <form action="{{route('stock-taking.creation')}}" method="get">
                    <input type="hidden" value="{{$row->id}}" id="stock" name="stock">

                    <button type="submit" style="direction:ltr;margin-top:-20px;background: rgba(139,0,0,.7);color:white;padding:5px ; border-color: rgba(139,0,0,.7);">إضافة جرد</button>
                ...
                <div class="sparkline13-list">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 style="direction:rtl">بيان جرد المخزن </h1>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('select[name="select_stock"]').on('change', function() {
            ...
            $.ajax({
                url: "{{route('stock-taking-selectStock.fetch')}}",
                method: "get",
                data: {
                    stock_id: stock,
