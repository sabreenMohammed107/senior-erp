...
<form action="{{url('/Financial/GLChart/Update')}}" method="post">
{{ csrf_field() }}
...
<a href="#" class="btn btn-primary waves-effect waves-light mg-b-15" data-toggle="modal" data-target="#del">مسح</a>
<a href="{{url('/Financial/GLChart')}}" class="btn btn-primary waves-effect waves-light mg-b-15">إلغــــاء</a>

	<button type="submit" class="btn btn-primary waves-effect waves-light mg-b-15">تعديل</button>
	<div class="row">
							...
							<div class="row res-rtl" style="display: flex ;flex-direction: row-reverse ;">
								...
								<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 mg-b-22">
									<div class="row">
										<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
											<div class="input-mark-inner mg-b-22">
												<input type="text" value="{{$node->code}}" readonly class="form-control" placeholder=""autofocus>
									...
									<div class="row">
										<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
											<div class="input-mark-inner mg-b-22">
											<input type="text" name="ar_name" value="{{$node->ar_name}}" class="form-control" placeholder="">
											</div>
										</div>
										<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
											<div class="input-mask-title">
									...
									<div class="row">
										<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
											<div class="input-mark-inner mg-b-22">
												<input type="text" name="en_name" value="{{$node->en_name}}" class="form-control" placeholder="">
											</div>
										</div>
										<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
											<div class="input-mask-title">
										...
										<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
											<div class="input-mark-inner mg-b-22">
												<select data-placeholder="Choose a Country..." disabled class="chosen-select">
													<option value="" selected>{{$node->code}} - {{$node->ar_name}}</option>
												</select>
											</div>
										</div>
										<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
									...
									<div class="row">
										<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
											<div class="input-mark-inner mg-b-22">
											<input type="text" value="{{$node->gl_item_level}}" readonly class="form-control" placeholder="">
											</div>
										</div>
										<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
											<div class="input-mask-title">
									...
									<div class="row">
										<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
											<div class="input-mark-inner mg-b-22">
											<input type="text" disabled value="{{$node->open_balance}}" name="open_balance" class="form-control" placeholder="">
											</div>
										</div>
										<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
											<div class="input-mask-title">
									...
									<div class="row">
										<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
											<div class="input-mark-inner mg-b-22">
											<input type="date" name="open_balance_date" value="{{$node->open_balance_date}}" disabled class="form-control" placeholder="">
											</div>
										</div>
										<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
											<div class="input-mask-title">
									...
									<div class="row">
										<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
											<div class="bt-df-checkbox" style="direction:rtl">
												...
												@if ($node->balance_type == 0)
												class="radio-checked" checked=""
												@endif
												value="0" id="optionsRadios1" name="balance_type">
												<label><b> مدين </b></label>
												<input type="radio" disabled
												@if ($node->balance_type == 1)
												class="radio-checked" checked=""
												@endif
												value="1" id="optionsRadios2" name="balance_type">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer info-md">
				...
				<a href="{{url("/Financial/GLChart/Delete/$node->id")}}">حـذف</a>
			</div>
		</div>
	</div>
</div>
