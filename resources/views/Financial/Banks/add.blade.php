...
<div class="row">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <ul class="breadcome-menu">
            <li>
                <a href="#"></a> البنوك<span class="bread-slash"> / </span>
            </li>
            <li>
                <span class="bread-blod">إضافة بنك </span>
            </li>
        </ul>
    </div>
</div>
                                ...
                                <div class="row res-rtl" style="display: flex ;flex-direction: row-reverse ;">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mg-b-22"style="direction:rtl">
                                        <div class="row">
                                            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                                <div class="input-mark-inner mg-b-22">
                                                    <input type="text" name="code" class="form-control" placeholder=""autofocus>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                                <div class="input-mark-inner mg-b-22">
                                                    <input type="text" name="branch_address" class="form-control" placeholder="">
                                                </div>
                                            </div>
                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                                <div class="input-mask-title">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                                <div class="input-mark-inner mg-b-22">
                                                    <input type="number" name="branch_phone" class="form-control" placeholder="">
                                                </div>
                                            </div>
                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                                <div class="input-mask-title">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                                <div class="input-mark-inner mg-b-22">
                                                    <input type="number" name="branch_fax" class="form-control" placeholder="">
                                                </div>
                                            </div>
                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                                <div class="input-mask-title">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mg-b-22"style="direction:rtl">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                                <select name="gl_item_id" id="gl_selector" data-placeholder="Choose a GLItem..." class="chosen-select">
                                                    <option value="" disabled selected>اختر الحساب</option>
                                                    @foreach ($GLItems as $Item)
                                                <option value="{{$Item->id}}" data-name="{{$Item->ar_name}}">{{$Item->code}} - {{$Item->ar_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                                <div class="input-mark-inner mg-b-22">
                                                    <input type="text" disabled id="gl_name" class="form-control" placeholder="">
                                                </div>
                                            </div>
                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                                <div class="input-mask-title">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                                <div class="input-mark-inner mg-b-22">
                                                    <input type="date" name="balance_start_date" class="form-control" placeholder="">
                                                </div>
                                            </div>
                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                                <div class="input-mask-title">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                                <div class="input-mark-inner mg-b-22">
                                                    <input disabled type="number" disabled name="current_balance" class="form-control" placeholder="">
                                                </div>
                                            </div>
                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                                <div class="input-mask-title">
