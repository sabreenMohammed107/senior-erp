...
<div class="row">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <ul class="breadcome-menu">
            ...
            <li>
                <span class="bread-blod">إضافة خزينة </span>
            </li>
        </ul>
    </div>
</div>
                        ...
                        <div class="form-group-inner" style="margin-right:10px;">
                            <div class="row res-rtl" style="display: flex ;flex-direction: row-reverse ;">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mg-b-22"style="direction:rtl">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                            <select name="gl_item_id" id="gl_selector" data-placeholder="Choose a Country..." class="chosen-select">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                            <div class="input-mark-inner mg-b-22">
                                                <input disabled type="text" id="gl_name" class="form-control" placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                            <div class="input-mask-title">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mg-b-22"style="direction:rtl">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                            <div class="input-mark-inner mg-b-22">
                                                <input disabled type="number" name="current_balance" class="form-control" placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                            <div class="input-mask-title">
