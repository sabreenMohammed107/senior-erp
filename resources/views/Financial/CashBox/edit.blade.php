...
<form action="{{url('/Financial/CashBox/Update')}}" method="post">
{{ csrf_field() }}
<div class="container-fluid">
<a href="{{url('/Financial/CashBox')}}" class="btn btn-primary waves-effect waves-light mg-b-15">رجــــــوع</a>
<a href="{{url('/Financial/CashBox')}}" class="btn btn-primary waves-effect waves-light mg-b-15">إلغــــاء</a>
                            ...
                            <div class="row res-rtl" style="display: flex ;flex-direction: row-reverse ;">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mg-b-22"style="direction:rtl">
                                    <div class="row">
                                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                            ...
                                            <input type="text" name="code" value="{{$CashBox->code}}" class="form-control" placeholder=""autofocus>
                                            <input type="hidden" name="id" value="{{$CashBox->id}}" class="form-control" placeholder="" autofocus>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                            <div class="input-mark-inner mg-b-22">
                                            <input type="text" value="{{$CashBox->ar_name}}" name="ar_name" class="form-control" placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                            <div class="input-mask-title">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                            <div class="input-mark-inner mg-b-22">
                                            <input type="text" value="{{$CashBox->en_name}}" name="en_name" class="form-control" placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                            <div class="input-mask-title">
                                            ...
                                            <select disabled name="branch_id" data-placeholder="Choose a Country..." class="chosen-select">
                                                ...
                                                @foreach ($UserBranches as $Branch)
                                                    <option value="{{$Branch->id}}"
                                                        @if ($CashBox->branch_id == $Branch->id)
                                                            selected="selected"
                                                        @endif
                                                        >{{$Branch->code}} - {{$Branch->ar_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                        ...
                                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                            <select disabled name="gl_iten_id" id="gl_selector" data-placeholder="Choose a Country..." class="chosen-select">
                                                ...
                                                @foreach ($GLItems as $Item)
                                                    <option value="{{$Item->id}}" data-name="{{$Item->ar_name}}"
                                                        @php
                                                            if($CashBox->gl_item_id == $Item->id){
                                                                $glname = $Item->ar_name;
                                                            }
                                                        @endphp
                                                        @if ($CashBox->gl_item_id == $Item->id)
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                            <div class="input-mark-inner mg-b-22">
                                                <input disabled type="text" value="{{$glname ?? ''}}" id="gl_name" class="form-control" placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                            <div class="input-mask-title">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mg-b-22"style="direction:rtl">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                            <div class="input-mark-inner mg-b-22">
                                                <textarea class="form-control" name="notes" placeholder="">{{$CashBox->notes}}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                            <div class="input-mask-title">
