            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="sparkline13-list">
                    ...
                    <div class="sparkline13-graph">
                        ...
                        <form action=""   class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload" style="direction:rtl">
                                          
                            <div class="chosen-select-single mg-b-20" style="direction:rtl;">
                                <div class="form-group">
                                    <label class="">كود التصنيف للبند</label>
                                    <input name="code" type="text" class="form-control" readonly value="{{$row->code}}" placeholder="XYZ-102/2036" style="text-align:right" disabled>
                                </div>
                            </div>
                                ...
                                <div class="row" style="text-align:right !important;direction:rtl !important">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input name="ar_description" readonly value="{{$row->ar_description}}" type="text" class="form-control" placeholder="" style="text-align:right">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            <label class="">وصف التصنيف باللغة الانجليزية</label>
                                            <input name="en_description" readonly value="{{$row->en_description}}" type="text" class="form-control" style="text-align:right">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer info-md">
                        <a  href="{{ route('item-category.index')}}">إلغــاء</a>
                    </div>
</form>
