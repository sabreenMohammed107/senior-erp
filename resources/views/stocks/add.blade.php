                                        ...
                                        <div class="row res-rtl" style="display: flex ;flex-direction: row-reverse ;">
											...
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="direction:rtl">
												<div class="form-group">
													...
													<input name="" type="text" class="form-control" placeholder="كود المخزن"disabled>
												</div>
												<div class="form-group">
													<label class="">إسم المخزن باللغة العربية</label>
													<input name="STOCK_AR_NAME" type="text" class="form-control" placeholder="إسم المخزن باللغة العربية">
												</div>
												<div class="form-group">
													<label class="">إسم المخزن باللغة الإنجليزية</label>
													<input name="STOCK_EN_NAME" type="text" class="form-control" placeholder="إسم المخزن باللغة الإنجليزية">
												</div>
												<div class="form-group">
													<div class="chosen-select-single mg-b-20">
														<label><b> أمين المخزن</b> </label>
														<input name="RESPONSIBLE_EMP_ID" type="number" class="form-control" placeholder=" أمين المخزن">
													</div>
												</div>
												<!-- <div class="form-group">
