							...
							<div class="sparkline16-graph">
								<div class="date-picker-inner" style="text-align:right">
									...
									<div class="form-group data-custon-pick" style="text-align:right">
										...
										<div class="input-mark-inner mg-b-22">
											<input type="text" name="ar_name" value="{{$row->ar_name}}" class="form-control" placeholder="">
										</div>
									</div>
									<div class="form-group data-custon-pick" style="text-align:right">
										<label>إسم الصنف باللغة الإنجليزية <span  style="color:red"> * </span></label>
										<div class="input-mark-inner mg-b-22">
											<input type="text" name="en_name" value="{{$row->en_name}}" class="form-control" placeholder="">
										</div>
									</div>
									<div class="form-group data-custon-pick" style="text-align:right">
								...
								<div class="row res-rtl"style="display: flex ;flex-direction: row-reverse ;">
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
										<div class="form-group data-custon-pick" style="text-align:right">
											...
											<div class="input-mark-inner mg-b-22">
												<textarea type="number" class="form-control"  name="ar_description" placeholder="" style="max-height:50px">{{$row->ar_description}}</textarea>
											</div>
										</div>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
										<div class="form-group">
											<div class="chosen-select-single mg-b-20">
												...
												<div class="input-mark-inner mg-b-22">
													<textarea type="number" class="form-control" name="en_description" placeholder=""style="max-height:50px">{{$row->en_description}}</textarea>
												</div>
											</div>
										</div>
									</div>
											...
											<div class="tsbox">
												...
												<div class="i-checks" style="float:right">
													<label><b>الصنف متاح للبيع</b>
														<input type="checkbox" value="1" @if($row->allow_sale_commission==1) checked @endif id="ALLOW_SELLING_COMMISSIONS"  name="allow_sale_commission"> <i></i>
													</label>
												</div>
											</div>
										</div>
										...
										<div class="colorpicker-inner ts-forms mg-b-23">
											<div class="tsbox">
												...
												<div class="i-checks" style="float:right">
													<label>
														<b>AlloweDiscounts</b>
														<input type="checkbox" value="1" @if($row->allowe_discount==1) checked @endif name="allowe_discount"> <i></i>
													</label>
												</div>
											</div>
										</div>
											...
											<div class="tsbox">
												...
												<div class="i-checks" style="float:right">
													<label><b>AllowSellingCommissions</b>
														<input type="checkbox" value="1" @if($row->allow_sale_commission==1) checked @endif name="allow_sale_commission"> <i></i> 
													</label>
												</div>
											</div>
										</div>
											...
											<div class="tsbox">
												...
												<div class="i-checks" style="float:right">
													<label>
														...
														<input type="checkbox" value="1" @if($row->allow_free_sale==1) checked @endif name="allow_free_sale"> <i></i>
													</label>
												</div>
											</div>
										</div>
