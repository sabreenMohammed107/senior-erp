    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <form action="{{route('outging-stock-trans.update',$row->id)}}" id="form-id" method="post">
                    @csrf
                    @method('PUT')
                    <div class="mg-b-23">
                        ...
                        <div id="confi" class="modal modal-edu-general fullwidth-popup-InformationproModal fade" role="dialog">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header header-color-modal bg-color-2">
                                        <h4 class="modal-title" style="text-align:right">تاكيد البيانات</h4>
                                        <div class="modal-close-area modal-close-df">
                                            <a class="close" data-dismiss="modal" href="#"><i class="fa fa-close"></i></a>
                                        </div>
                                    </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1 style="direction:rtl"> تعديل حركات المخزن </h1><br />
                                </div>
                            </div>
                                        ...
                                        <div class="row res-rtl" style="display: flex ;flex-direction: row-reverse ;">
                                            ...
                                            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 mg-b-22">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                                        <div class="input-mark-inner mg-b-22">
                                                            <select id="secondary_stock_id" disabled name="secondary_stock_id" data-placeholder="Choose a Country..." class="chosen-select">
                                                                @foreach($secondStocks as $second)
                                                                <option @if ($row->secondary_stock_id == $second->id)
                                                                        selected="selected"
                                                                        @endif value="{{$second->id}}">{{$second->ar_name}} / {{$second->code}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                                        <div class="input-mark-inner mg-b-22">
                                                            <textarea type="text" disabled name="notes" class="form-control" placeholder="">{{$row->notes}}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                                        <div class="input-mask-title">
...
<tr data-id="{{$counter}}">
    ...
    <td>
        <div class="input-mark-inner mg-b-22">
            <input type="number" readonly style="width: 200px" max="{{$data->item_total_qty ?? ''}}" oninput="itemQty({{$counter}})" value="{{$itemo->item_qty}}" onfocusout="maxQty({{$counter}})" name="upqty{{$counter}}" id="qty{{$counter}}" class="form-control item_quantity" placeholder="">
        </div>
    </td>
...
<input type="number" style="display: none;" value="{{$counterrrr}}" name="qqq" class="form-control item_quantity" placeholder="">
		...
		$.ajax({
			type: 'GET',
			url: "{{url('/outging-stock-trans/Remove-virtual/Item')}}",
			data: {
				id: id,
