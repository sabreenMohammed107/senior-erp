...
<input type="number" style="display: none;" value="{{$itemo->item_id}}" name="selectup{{$counter}}" id="selectup{{$counter}}"  class="form-control " placeholder="">
    ...
    <td>
        <div class="input-mark-inner">
            <input type="text" id="orBatch{{$counter}}" value="{{$itemo->batch_no}}" name="orBatch{{$counter}}" class="form-control" placeholder="Some Text Here" style="width: 130px">
        </div>
    </td>
    <td>
    <?php
   ...
   ?>
        ...
        <div class="input-mark-inner">
            <input type="date" id="orDate{{$counter}}" value="{{ date_format($date, "d-m-Y")}}" name="orDate{{$counter}}" class="form-control" placeholder="Some Text Here" style="width: 130px">
        </div>
    </td>
    <td>
        <div class="input-mark-inner">
    ...
    <td>
        <div class="input-mark-inner">
            <input type="text" id="notes{{$counter}}" value="{{$itemo->notes}}" name="notesup{{$counter}}" value="{{$itemo->notes}}" oninput="itemNotes({{$counter}})" onkeypress="enterForRow(event,{{$counter}})" class="form-control" placeholder="" style="width: 200px">
        </div>
    </td>
    <td>
