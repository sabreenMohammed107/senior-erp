									...
									<div class="row res-rtl" style="display: flex ;flex-direction: row-reverse ;">
										...
										<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mg-b-22">
											...
											<div class="row">
												<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                                    ...
                                                    <?php
														...
														<input type="date" readonly value="{{date_format($date2,"Y-m-d") }}" name="transaction_date" class="form-control" placeholder="">
													</div>
												</div>
												<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
													<div class="input-mask-title">
											...
											<div class="row">
												<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
													<div class="input-mark-inner mg-b-22">
														<textarea name="notes" disabled class="form-control" placeholder="">{{$row->notes}}</textarea>
													</div>
												</div>
												<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
													<div class="input-mask-title">
...
<input type="number" style="display: none;" value="{{$itemo->item_id}}" name="selectup{{$counter}}" id="selectup{{$counter}}"  class="form-control " placeholder="">
    ...
    <td>
        <div class="input-mark-inner">
            <input type="text" readonly id="orBatch{{$counter}}" value="{{$itemo->batch_no}}" name="orBatch{{$counter}}" class="form-control" placeholder="Some Text Here" style="width: 130px">
        </div>
    </td>
    <td>
    <?php
   ...
   ?>
        ...
        <div class="input-mark-inner">
            <input type="date" readonly id="orDate{{$counter}}" value="{{ date_format($date, "d-m-Y")}}" name="orDate{{$counter}}" class="form-control" placeholder="Some Text Here" style="width: 130px">
        </div>
    </td>
    <td>
        <div class="input-mark-inner">
            <input type="number" readonly id="orqty{{$counter}}" value="{{$itemo->item_qty}}" name="orqty{{$counter}}" class="form-control" style="width: 130px">
        </div>
    </td>
    <td>
        <div class="input-mark-inner">
            <input type="text" readonly id="notes{{$counter}}" value="{{$itemo->notes}}" name="notesup{{$counter}}" value="{{$itemo->notes}}" oninput="itemNotes({{$counter}})" onkeypress="enterForRow(event,{{$counter}})" class="form-control" placeholder="" style="width: 200px">
        </div>
    </td>
