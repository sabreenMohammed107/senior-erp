	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<form action="{{route('warehouse-receiver.store')}}" id="form-id" method="post">
					@csrf
					<div class="mg-b-23">
							...
							<div class="datatable-dashv1-list custom-datatable-overright">
								<div class="form-group-inner" style="margin-right:10px;">
									<div class="row res-rtl" style="display: flex ;flex-direction: row-reverse ;">
										...
										<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mg-b-22">
											<div class="row">
												<input type="hidden" value="{{$stock_id}}" id="stock" name="stock">

												<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
													<div class="input-mark-inner mg-b-22">
														<input type="text" class="form-control" placeholder="" autofocus readonly>
													</div>
												</div>
											...
											<div class="row">
												<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
													<div class="bt-df-checkbox" style="direction:rtl">
														<input class="radio-checked" type="radio" onclick="general()" checked="" value="general" id="optionsRadios1" name="optionsRadios">
														<label><b> عام </b></label>
														<input class="" type="radio" value="order" onclick="order()" id="optionsRadios2" name="optionsRadios">
										...
										<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mg-b-22">
											...
											<div id="orders" class="row">
												<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
													<div class="input-mark-inner mg-b-22">
														<select data-placeholder="Choose a Country..." id="purchOrder" name="purchOrder" class="chosen-select">
															...
															<option value="{{$order->id}}">{{date_format($date,"Y-m-d") }} / {{$order->purch_order_no}}</option>
															@endforeach
														</select>
													</div>
												</div>
								...
								<div style="overflow-x:auto;">
									...
									<table class="table  table-bordered" id="table" style="direction:rtl;">
										...
										<tbody id="rows">
											@include('warehouse-receiver.fromOrder')
										</tbody>
...
<script>
	function order() {
		...
		$('#purchOrder').val('').trigger('chosen:updated');
