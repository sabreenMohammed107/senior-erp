...
<div class="row">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <ul class="breadcome-menu">
            ...
            <li>
                <span class="bread-blod"> إضافة حركة تالف مخزن </span>
            </li>
        </ul>
    </div>
</div>
...
<div class="single-pro-review-area mt-t-30 mg-b-15">
    ...
    <form action="{{route('expired-items.store')}}" id="formid" method="post">
                    @csrf
                    <div class="mg-b-23">
                    ...
                    <div class="sparkline13-list">
                        ...
                        <div class="sparkline13-graph">
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                                    <div class="input-mark-inner mg-b-22">
                                                        ...
                                                        <input type="date" id="date" name="transaction_date" value="{{ date_format($date, 'Y-m-d')}}" class="form-control" placeholder="">
                                                    </div>
                                                </div>
                                                <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                                    <div class="input-mask-title">
                                ...
                                <button class="btn_add_item" type="button" onclick="getExpired()"> توالف بالتاريخ</button>
                                ...
                                <table class="table  table-bordered" id="table" style="direction:rtl;">
                                    ...
                                    <tbody id="rows">
                                        ...
                                        @include('expired-items.expiredAjax')
                                    </tbody>
                                </table>
                            </div>
                        </div>
