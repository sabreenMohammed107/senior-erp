...
<div class="row">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <ul class="breadcome-menu">
            ...
            <li>
                <span class="bread-blod">  حركة تالف مخزن </span>
            </li>
        </ul>
    </div>
</div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="sparkline13-list">
                        ...
                        <div class="sparkline13-graph">
                                ...
                                <div class="form-group-inner" style="margin-right:10px;">
                                    <div class="row res-rtl" style="display: flex ;flex-direction: row-reverse ;">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                                <div class="input-mark-inner mg-b-22">
                                                    <textarea class="form-control" disabled name="notes" placeholder="">{{$transObj->notes}}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                                <div class="input-mask-title">
                            ...
                            <button id="add" type="button" class="btn_add_item isDisabled">إضافة صنف</button>
...
<tr data-id="{{$counter}}">
    ...
    <td>
        <div class="input-mark-inner mg-b-22">
            <input type="text" readonly style="width: 200px" readonly onkeypress="enterForRow(event,{{$counter}})" value="{{$itemo->notes}}" name="updetNote{{$counter}}" class="form-control detNote" placeholder="ملاحظات">
        </div>
    </td>
