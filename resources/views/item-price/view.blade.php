                                        ...
                                        <tr data-id="{{$counter}}">
                                            ...
                                            <td>
                                                <div class="input-mark-inner mg-b-22">
                                                    <input readonly type="number" onkeypress="enterForRow(event,{{$counter}})" id="itemprice{{$counter}}" name="item_priceup{{$counter}}" oninput="itemPrice({{$counter}})" value="{{$itemo->item_price}}" class="form-control item_price" placeholder="">
                                                </div>
                                            </td>
                                            <td>
