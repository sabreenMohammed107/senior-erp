<tr data-id="{{$rowCount}}">
    ...
    <td>
        <div class="input-mark-inner mg-b-22">
            <input type="number" style="width: 200px" min="0" value="0"  oninput="itemQty({{$rowCount}})"  name="qty{{$rowCount}}" id="qty{{$rowCount}}"  class="form-control item_quantity" placeholder="">
        </div>
    </td>
