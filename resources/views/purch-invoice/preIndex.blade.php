...
<h3 style="text-align:right">بيانات فواتير الشراء</h3>
        ...
        <tr>
            ...
            <td>
                <div class="product-buttons">
                    <a  href="{{route('purch-invoice.show',$invoice->id)}}"><button title="View" class="pd-setting-ed"><i class="fa fa-file" aria-hidden="true"></i></button></a>
                    <a @if($invoice->confirmed == 1) class="isDisabled" @endif href="{{route('purch-invoice.edit',$invoice->id)}}"><button title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
