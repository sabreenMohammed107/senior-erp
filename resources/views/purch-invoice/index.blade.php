	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="breadcome-heading">
			<div class="add-product">
				<form action="{{route('purch-invoice.creation')}}" method="get">
					<input type="hidden" value="{{$row->id}}" id="branch" name="branch">

					<button type="submit" style="direction:ltr;margin-top:-20px;background: rgba(139,0,0,.7);color:white;padding:5px ; border-color: rgba(139,0,0,.7);">إضافة فاتورة مشتريات</button>
				...
				<div class="sparkline13-list">
					...
					<div class="sparkline13-graph">
						<div class="datatable-dashv1-list custom-datatable-overright" style="direction:rtl">
							...
							<div id="preIndex">
								@include('purch-invoice.preIndex')
							</div>
...
<script>
	$(document).ready(function() {
		...
		$('select[name="select_branch"]').on('change', function() {
			...
			$.ajax({
				url: "{{route('dynamicBranchPurchInvoice.fetch')}}",
				method: "get",
				data: {
					branch_id: branch,
