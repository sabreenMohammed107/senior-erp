    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <form action="{{route('purch-order.update',$orderObj->id)}}" id="form-id" method="post">
                    @csrf
                    @method('PUT')
                    <div class="mg-b-23">
                                        ...
                                        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 shadow">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                                    ...
                                                    <div class="input-mark-inner mg-b-22">
                                                        <input type="text" class="form-control" name="notes" value="{{$orderObj->notes}}" id="notes" placeholder="" style="height:80px;margin-bottom:10px;">
                                                    </div>
                                                </div>
