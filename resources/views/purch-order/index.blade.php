								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div class="breadcome-heading">
											...
											<form action="{{route('purch-order.creation')}}" method="get">
											<input type="hidden" value="{{$row->id}}" id="branch" name="branch">

											<button type="submit" style="direction:ltr;margin-top:-20px;background: rgba(139,0,0,.7);color:white;padding:5px ; border-color: rgba(139,0,0,.7);">إضافة أمر شراء</button>
						...
						<div class="sparkline13-list">
							<div class="sparkline13-hd">
								<div class="main-sparkline13-hd">
									<h1 style="direction:rtl">أوامر الشراء</h1>
								</div>
							</div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('select[name="select_branch"]').on('change', function() {
            ...
            $.ajax({
                url: "{{route('selectBranch-purchOrder.fetch')}}",
                method: "get",
                data: {
                    branch_id: branch,
