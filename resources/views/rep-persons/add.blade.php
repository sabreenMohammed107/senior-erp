...
<div class="single-pro-review-area mt-t-30 mg-b-15">
    <div class="container-fluid">
        <form action="{{route('rep-persons.store')}}" method="POST">
            @csrf
            <a href="{{route('rep-persons.index')}}" class="btn btn-primary waves-effect waves-light mg-b-15">رجوع</a>

            <button class="btn btn-primary waves-effect waves-light mg-b-15" type="submit">حــفـظ</button>
            <div class="row">
                                    ...
                                    <div class="row res-rtl" style="display: flex ;flex-direction: row-reverse ;">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="direction:rtl">
                                            <div class="form-group">
                                                ...
                                                <input name="" readonly type="text" class="form-control" placeholder="" style="text-align:right">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="mobile" type="text" class="form-control" style="text-align:right">
                                            </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="direction:rtl">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select data-placeholder="Choose a Country..." name="rep_type_id" class="chosen-select">
