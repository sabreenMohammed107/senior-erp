...
<div class="data-table-area mg-b-15">
    <div class="container-fluid">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="mg-b-23">
                        <div class="">
                            ...
                            <a href="{{route('approve-order.index')}}" class="btn btn-primary waves-effect waves-light">إلغاء</a>
                           

                            <button data-toggle="modal"  @if($orderObj->ORDER_DECISION_STATUS_ID ==2 ||$orderObj->ORDER_DECISION_STATUS_ID ==3) disabled @endif  data-target="#reject{{$orderObj->ORDER_ID}}" title="Trash" class="pd-setting-ed">عدم الموافقة</button>
                            <button data-toggle="modal" @if($orderObj->ORDER_DECISION_STATUS_ID ==2 ||$orderObj->ORDER_DECISION_STATUS_ID ==3) disabled @endif data-target="#accept{{$orderObj->ORDER_ID}}" title="Trash" class="btn btn-primary"> موافقه</button>


                        </div>
                    </div>
                     <!--accept Company-->
		<div id="accept{{$orderObj->ORDER_ID}}" class="modal modal-edu-general fullwidth-popup-InformationproModal fade" role="dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-footer info-md">
                        ...
                        <form id="delete" style="display: inline;" action="{{route('approveOrder')}}" method="POST">
													@csrf
                                                    <input type="hidden" value="{{$orderObj->ORDER_ID}}" name="approveOrder" >	
        ...
        <!--/accept Company-->
         ...
         <!--reject Company-->
		<div id="reject{{$orderObj->ORDER_ID}}" class="modal modal-edu-general fullwidth-popup-InformationproModal fade" role="dialog">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header header-color-modal bg-color-2">
					...
					<div class="modal-footer info-md">
                        ...
                        <form id="delete" style="display: inline;" action="{{route('rejectOrder')}}" method="POST">
													@csrf
											<input type="hidden" value="{{$orderObj->ORDER_ID}}" name="rejectOrder" >	
													<button type="submit">نعم</button>
												</form>
					</div>
				</div>
                            ...
                            <div class="form-group-inner" style="margin-right:10px;">
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 shadow">
												<div class="row"style="direction:rtl">
													<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                                        ...
                                                        <input class="" disabled type="radio" @if($orderObj->ORDER_DECISION_STATUS_ID==2) checked="" @endif value="option2" id="optionsRadios2" name="optionsRadios2">
															<label><b> تمت الموافقة </b></label>
															<input class="radio-checked" disabled type="radio" @if($orderObj->ORDER_DECISION_STATUS_ID==3) checked="" @endif value="option1" id="optionsRadios1" name="optionsRadios2">
                                                            <label><b> تم الرفض </b></label>
                                                            <input class="radio-checked" disabled type="radio" @if($orderObj->ORDER_DECISION_STATUS_ID==1) checked="" @endif value="option1" id="optionsRadios1" name="optionsRadios2">
                                ...
                                <table class="table-striped" id="puchasetable" data-locale="ar-SA" data-pagination="true" data-pagination-pre-text="السابق" data-pagination-next-text="التالي" data-show-export="true" data-minimum-count-columns="2" data-page-list="[10, 25, 50, 100, all]" data-sort-name="index" data-sort-order="desc" data-search="true" style="direction:rtl" data-toggle="table" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-resizable="true" data-cookie="true" data-toolbar="#toolbar" data-show-toggle="true" data-show-fullscreen="true" data-show-columns-toggle-all="true">
                                    ...
                                    <tbody id="rows">
                                        ...
                                        @include('approve-order.editAjax')
                                    </tbody>
