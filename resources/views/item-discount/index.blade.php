...
<div class="data-table-area mg-b-15">
    ...
    <a href="{{ route('item-discount.create') }}" title="New" class="btn btn-primary waves-effect waves-light mg-b-15">إضافة خصم </a>
        <div class="row">
                             ...
                             data-toolbar="#toolbar">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$row->item_discount_price}}</td>
                                     
                                        <td>
                                            <div class="product-buttons">
                                                <a href="{{ route('item-discount.show',$row->item_id)}}"><button title="View" class="pd-setting-ed"><i class="fa fa-file" aria-hidden="true"></i></button></a>
                                                <a href="{{ route('item-discount.edit',$row->item_id)}}"><button title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                            </div>
                                        </td>
                                    </tr>
