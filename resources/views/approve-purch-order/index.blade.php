...
<div class="row">
	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<ul class="breadcome-menu">
			...
			<li>
				<span class="bread-blod"> الموافقة على أمر الشراء</span>
			</li>
		</ul>
	</div>
</div>
				...
				<div class="sparkline13-list">
					<div class="sparkline13-hd">
						<div class="main-sparkline13-hd">
							<h1 style="direction:rtl">الموافقة على أوامر الشراء</h1>
						</div>
					</div>
					<div class="sparkline13-graph">
						<div class="datatable-dashv1-list custom-datatable-overright" style="direction:rtl">
							...
							<div id="preIndex">
								@include('approve-purch-order.preIndex')
							</div>
...
<script>
	$(document).ready(function() {
		...
		$('select[name="select_branch"]').on('change', function() {
			...
			$.ajax({
				url: "{{route('dynamicApprovalOrder-purch.fetch')}}",
				method: "get",
				data: {
					branch_id: branch,
