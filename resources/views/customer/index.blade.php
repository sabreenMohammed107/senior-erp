...
<div class="data-table-area mg-b-15">
    ...
    <a href="{{ route('customer.create') }}" title="New" class="btn btn-primary waves-effect waves-light mg-b-15">إضافة عميل </a>
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="sparkline13-list">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 style="direction:rtl">العملاء</h1>
                        </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="product-buttons">
                                                <a href="{{ route('customer.show',$row->id)}}"><button title="View" class="pd-setting-ed"><i class="fa fa-file" aria-hidden="true"></i></button></a>
                                                <a href="{{ route('customer.edit',$row->id)}}"><button title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer info-md">
                                                    ...
                                                    <form id="delete" style="display: inline;" action="{{ route('customer.destroy', $row->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
